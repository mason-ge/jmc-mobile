  ...
  <div class="goodInfo">
    <div class="info">
      <div
        class="top"
        ref="top"
        :style="{backgroundColor:'rgba(255,255,255,'+topOption.topOpacity+')'}"
      >
        <div class="top1">
          <i
            class="btn iconfont icon-fanhui"
            @click="backFn"
            :style="{backgroundColor:'rgba(0,0,0,'+topOption.btnBackColor+')',color:topOption.btnFontColor}"
          ></i>
          <i
            class="btn iconfont icon-cart"
            @click="toCartFn"
            :style="{backgroundColor:'rgba(0,0,0,'+topOption.btnBackColor+')',color:topOption.btnFontColor}"
          ></i>
        </div>
        ...
        <div
          class="top3"
          :style="{opacity:topOption.topOpacity,backgroundImage:'url('+goodsData.img+')'}"
        ></div>
      </div>
      <div class="main">
        <div class="img">
